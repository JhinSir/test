...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public void doAttachBaseContext(Context context,  String packageName,  boolean isHideRt,  boolean isHideXps) {
        number=number+1;
        final String pkg=packageName;
        final boolean isHideR=isHideRt;
        final boolean isHideX=isHideXps;
